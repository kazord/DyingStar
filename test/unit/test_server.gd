...
func before_all():
	# define players
	GameOrchestrator._game_server.players = {
	...
	GameOrchestrator._game_server.ServerSDOInfo = {
		"id": 5,
		"name": "gameserver0101",
		"ip": "127.0.0.1",
		"port": 7050,
...
func test_server__check_player_in_zone__player_in_zone():
	var inZone = GameOrchestrator._game_server._check_player_in_zone("c7b06780-7100-4c5d-8841-90985eea8b6d")
	assert_true(inZone)

func test_server__check_player_in_zone__player_not_in_zone():
	var inZone = GameOrchestrator._game_server._check_player_in_zone("30be488b-2c60-473d-9595-b9ff551dcf80")
	assert_false(inZone)

func test_server__check_server_have_zone_contain_server_position__have_server():
	var serverFound = GameOrchestrator._game_server._check_server_have_zone_contain_server_position("30be488b-2c60-473d-9595-b9ff551dcf80")
...
func test_server__check_server_have_zone_contain_server_position__not_have_server():
	var serverFound = GameOrchestrator._game_server._check_server_have_zone_contain_server_position("6ebb847c-9c25-466a-989f-c1cf5ad3366f")
